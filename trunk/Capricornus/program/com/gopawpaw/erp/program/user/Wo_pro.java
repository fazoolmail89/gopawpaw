 ...
 *
 */
public class Wo_pro extends ReportParameterFrame implements GppJarRunableInterface{
	 ...
	 */
	public Wo_pro() throws HeadlessException {
		initialize();
	}
	 ...
	 * @param gc
	 */
	public Wo_pro(GraphicsConfiguration gc) {
		super(gc);
		initialize();
	 ...
	 * @throws HeadlessException
	 */
	public Wo_pro(String title) throws HeadlessException {
		super(title);
		initialize();
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param gc
	 */
	public Wo_pro(String title, GraphicsConfiguration gc) {
		super(title, gc);
		initialize();
		// TODO Auto-generated constructor stub
	}
