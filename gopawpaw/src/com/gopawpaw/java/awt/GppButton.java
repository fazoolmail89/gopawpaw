 ...
 * @author 李锦华
 */
public class GppButton extends Button implements GppKeyActionListener,GppComponentAuthorizationControlInterface{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2301414132229184956L;
	/**
	 ...
	 */
	public GppButton(String arg0) throws HeadlessException {
		super(arg0);
		initialize();
	}
	 ...
	 * @throws HeadlessException
	 */
	public GppButton() throws HeadlessException {
		super();
		initialize();
	}
