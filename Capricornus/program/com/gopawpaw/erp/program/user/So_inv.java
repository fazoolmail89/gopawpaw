 ...
 *
 */
public class So_inv extends ReportParameterFrame implements GppJarRunableInterface{
	 ...
	 */
	public So_inv() throws HeadlessException {
		initialize();
	}
	 ...
	 * @param gc
	 */
	public So_inv(GraphicsConfiguration gc) {
		super(gc);
		initialize();
	 ...
	 * @throws HeadlessException
	 */
	public So_inv(String title) throws HeadlessException {
		super(title);
		initialize();
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param gc
	 */
	public So_inv(String title, GraphicsConfiguration gc) {
		super(title, gc);
		initialize();
		// TODO Auto-generated constructor stub
	}
