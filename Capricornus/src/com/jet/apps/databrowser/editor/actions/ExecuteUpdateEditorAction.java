...
/** */
public class ExecuteUpdateEditorAction extends SyntaxEditorAction
{   
   public ExecuteUpdateEditorAction() {
      super();
   }
   ...
   public void actionPerformed(ActionEvent ae) {
      ...
      //System.out.println ("Calling execute update");
      databrowser.getSession().executeUpdate(sql);
   }
}
