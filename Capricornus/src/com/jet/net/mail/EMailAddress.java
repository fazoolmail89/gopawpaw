...
/**
 * Encapsulates and email address.
 * 
...
public class EMailAddress implements java.io.Serializable
{
   ...
   /** The address. ex: bemowski@someserver.com */
    ...
    * 
    * or, just to make my life difficult <p>
    *
    * "last, first" <last@somewhere.com> <p>
    *
    * or if no real name is available<p>
    *
    * <address@somewhere.com> <p>
    */
   public EMailAddress(String line) {
      ...
      if (addStart == -1) {
         ...
         // So if bemowski@someserver.com is passed into this 
   ...
   /** Returns the internet email address user@host format. */
