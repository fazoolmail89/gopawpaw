...
public class Omnd_det {
	...
	private com.gopawpaw.frame.dataEntity.Dmnd_det dmnd_det = null;
	...
	public com.gopawpaw.frame.dataEntity.Dmnd_det getDmnd_det() {
		if (dmnd_det == null) {
	 ...
	 *            the dmnd_det to set
	 */
	public void setDmnd_det(com.gopawpaw.frame.dataEntity.Dmnd_det dmndDet) {
		dmnd_det = dmndDet;
	}
