...
import com.gopawpaw.frame.utils.GppCommonDBAccess;
...
//			GLog.d("", password);
	 ...
	 * @return string values
	 */
	public String getString(int fileindex) {
		try {
	 ...
	 * @return int values
	 */
	public int getInt(int fileindex) {
		try {
			return Integer.parseInt(this.rstSql.getString(fileindex));
		} catch (Exception e) {
			return 0;
		}
	}
